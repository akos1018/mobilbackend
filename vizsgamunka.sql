...
--
-- Gép: localhost
-- Létrehozás ideje: 2022. Jan 18. 10:45
...
--
ALTER TABLE `ajanlas`
  MODIFY `ajanlas_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT a táblához `ertekeles`
--
ALTER TABLE `ertekeles`
  MODIFY `ertekeles_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=175;
...
--
ALTER TABLE `komment`
  MODIFY `komment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
